...
class CreateOrganizationsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection(pBusinessDBConnectionName())->create('organizations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection(pBusinessDBConnectionName())->dropIfExists('organizations');
    }
}
