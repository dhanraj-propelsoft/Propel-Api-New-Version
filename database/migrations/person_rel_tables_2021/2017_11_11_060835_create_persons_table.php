...
class CreatePersonsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('persons', function (Blueprint $table) {
             ...
             $table->increments('id');
            $table->string('crm_code', 10)->unique()->nullable(true);
            ...
            $table->timestamps();
             ...
             $table->foreign('salutation')->references('id')->on('salutations')
            ...
            $table->foreign('life_state_id')->references('id')->on('person_life_states')
                ->onUpdate('cascade')->onDelete('set null');  

            $table->foreign('depone_state_id')->references('id')->on('person_depone_states')
                ->onUpdate('cascade')->onDelete('set null');  

            $table->foreign('current_state_id')->references('id')->on('person_current_states')
                ->onUpdate('cascade')->onDelete('set null');         
